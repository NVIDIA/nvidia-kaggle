...
The Kaggle website and service at [Kaggle](https://www.kaggle.com/) are used as an external service / API and are not a distributed code dependency of this repository.
...
- kaggle (Kaggle API/CLI)  
  License: Apache-2.0  
  Upstream: [Kaggle/kaggle-api](https://github.com/Kaggle/kaggle-api)
...
- RAPIDS cuDF  
  License: Apache-2.0  
  Upstream: [rapidsai/cudf](https://github.com/rapidsai/cudf)
...
- claude-agent-sdk  
  License: MIT  
  Upstream: [anthropics/claude-code-sdk-python](https://github.com/anthropics/claude-code-sdk-python)

- pydantic  
  License: MIT  
  Upstream: [pydantic/pydantic](https://github.com/pydantic/pydantic)

- pytest  
  License: MIT  
  Upstream: [pytest-dev/pytest](https://github.com/pytest-dev/pytest)

- rich  
  License: MIT  
  Upstream: [Textualize/rich](https://github.com/Textualize/rich)

- hatchling  
  License: MIT  
  Upstream: [pypa/hatch](https://github.com/pypa/hatch)

- CuPy  
  License: MIT  
  Upstream: [cupy/cupy](https://github.com/cupy/cupy)

### BSD-3-Clause

- httpx  
  License: BSD-3-Clause  
  Upstream: [encode/httpx](https://github.com/encode/httpx)

- nbformat  
  License: BSD-3-Clause  
  Upstream: [jupyter/nbformat](https://github.com/jupyter/nbformat)

- numpy  
  License: BSD-3-Clause  
  Upstream: [numpy/numpy](https://github.com/numpy/numpy)

- pandas  
  License: BSD-3-Clause  
  Upstream: [pandas-dev/pandas](https://github.com/pandas-dev/pandas)

- python-dotenv  
  License: BSD-3-Clause  
  Upstream: [theskumar/python-dotenv](https://github.com/theskumar/python-dotenv)
